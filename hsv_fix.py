...
def main(img):
    ...
    # RGB 顏色調整軸0~255
    cv2.createTrackbar('H_1_0', 'image', 0, 255, nothing)
    cv2.createTrackbar('S_1_0', 'image', 0, 255, nothing)
    cv2.createTrackbar('V_1_0', 'image', 0, 255, nothing)
    cv2.createTrackbar('H_1_1', 'image', 75, 255, nothing)
    cv2.createTrackbar('S_1_1', 'image', 255, 255, nothing)
    cv2.createTrackbar('V_1_1', 'image', 255, 255, nothing)
    cv2.createTrackbar('H_2_0', 'image', 150, 255, nothing)
    cv2.createTrackbar('S_2_0', 'image', 0, 255, nothing)
    cv2.createTrackbar('V_2_0', 'image', 0, 255, nothing)
    cv2.createTrackbar('H_2_1', 'image', 255, 255, nothing)
    cv2.createTrackbar('S_2_1', 'image', 255, 255, nothing)
    cv2.createTrackbar('V_2_1', 'image', 255, 255, nothing)
